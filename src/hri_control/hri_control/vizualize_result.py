...
#Setting up the environment and running and loading the model
def main():
    rclpy.init()
   ...
   #Plotting the graph, which has the 3D Trajectory, the robot path and the start and end point. While also plotting the hand position to show the comparison
